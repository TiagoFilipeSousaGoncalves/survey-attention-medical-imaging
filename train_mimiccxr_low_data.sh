...
python code/models_train.py --data_dir /ctm-hdd-pool01/wjsilva19/MedIA --dataset MIMICCXR --model DeiT-LRP --batchsize 16 --classweights --epochs 300 --lr 1e-6 --num_workers 4 --gpu_id 1 --save_freq 1000
