...
python code/models_train.py --data_dir /ctm-hdd-pool01/tgoncalv/datasets/APTOS2019_resized/ --dataset APTOS --model DeiT-LRP --low_data_regimen --perc_train 0.01 --batchsize 16 --epochs 300 --lr 1e-6 --num_workers 2 --gpu_id 0 --save_freq 1000
# python code/models_train.py --data_dir /ctm-hdd-pool01/tgoncalv/datasets/APTOS2019_resized/ --dataset APTOS --model DeiT-LRP --low_data_regimen --perc_train 0.1 --batchsize 16 --epochs 300 --lr 1e-6 --num_workers 2 --gpu_id 0 --save_freq 1000
# python code/models_train.py --data_dir /ctm-hdd-pool01/tgoncalv/datasets/APTOS2019_resized/ --dataset APTOS --model DeiT-LRP --low_data_regimen --perc_train 0.5 --batchsize 16 --epochs 300 --lr 1e-6 --num_workers 2 --gpu_id 0 --save_freq 1000
