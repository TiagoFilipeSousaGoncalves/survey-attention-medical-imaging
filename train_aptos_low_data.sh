...
python code/models_train.py --data_dir /ctm-hdd-pool01/tgoncalv/datasets/APTOS2019_resized/ --dataset APTOS --model DeiT-LRP --batchsize 32 --epochs 300 --lr 1e-6 --num_workers 4 --gpu_id 0 --save_freq 1000
