...
# Project Imports
from baseline_model_utilities import VGG16, DenseNet121
...
# History Files
history_dir = os.path.join("results", "ph2", "history")
...
_, _, nr_classes = map_images_and_labels(data_dir=data_dir)
