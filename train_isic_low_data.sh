...
python code/models_train.py --data_dir /ctm-hdd-pool01/tgoncalv/datasets/ISIC2020/ --dataset ISIC2020 --model DeiT --low_data_regimen --perc_train 0.5 --batchsize 32 --classweights --epochs 300 --lr 1e-6 --num_workers 4 --gpu_id 1 --save_freq 1000
