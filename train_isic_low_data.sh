...
python code/models_train.py --data_dir /ctm-hdd-pool01/tgoncalv/datasets/ISIC2020/ --dataset ISIC2020 --model DeiT-LRP --batchsize 16 --classweights --epochs 300 --lr 1e-6 --num_workers 4 --gpu_id 0 --save_freq 1000